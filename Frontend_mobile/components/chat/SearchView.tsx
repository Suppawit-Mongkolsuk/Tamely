    ...
    {[
      {
        ...
        channel: "general",
        content: "Let's schedule the Q1 roadmap review",
      },
      {
        author: "Mike Chen",
        channel: "engineering",
...
const FileResults = () => (
  <View style={styles.section}>
    {[
      ...
      <View key={i} style={styles.card}>
        <Text style={styles.author}>{file.name}</Text>
        <Text style={styles.content}>{file.size}</Text>
      </View>
    ))}
  </View>
);
...
const PeopleResults = () => (
  <View style={styles.section}>
    {[
      ...
      <View key={i} style={styles.card}>
        <Text style={styles.author}>{person.name}</Text>
        <Text style={styles.content}>{person.role}</Text>
      </View>
    ))}
  </View>
);
...
const styles = StyleSheet.create({
  ...
  content: { color: "#4B5563", fontSize: 13 },
});