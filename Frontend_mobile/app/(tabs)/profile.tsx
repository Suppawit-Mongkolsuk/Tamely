  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <TouchableOpacity onPress={() => router.push('/profile-edit' as any)} style={{ margin: 20, padding: 16, backgroundColor: '#f5f7ff', borderRadius: 16, flexDirection: 'row', alignItems: 'center' }}>
        ...
        <TouchableOpacity onPress={() => router.push('/profile-edit' as any)} style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 20 }}>
        ...
        {isAdminOrOwner && (
          <TouchableOpacity
            onPress={() => router.push({
              pathname: '/workspace-management' as any,
